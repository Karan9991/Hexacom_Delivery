import 'package:emarket_delivery_boy/data/model/response/language_model.dart';
import 'package:emarket_delivery_boy/utill/images.dart';

class AppConstants {
  static const String APP_NAME = 'Hexacom Delivery Boy';
  static const double APP_VERSION = 6.2;

  static const String BASE_URL = 'http://hexacom.x10.mx';
  ...
  static const String GET_MESSAGE_URI =
      '/api/v1/delivery-man/message/get-message';
  static const String SEND_MESSAGE_URI =
